...
import { AddTeammateSheet } from "./screens/AddTeammateSheet";
...
export function App() {
  ...
  return (
    <div className="app" style={{ position: "relative" }}>
      ...
      {sheet.kind !== "none" && <div className="dim" onClick={() => ["keys", "agent", "wake", "channel", "skills", "removeTeam", "add-agent"].includes(sheet.kind) && store.closeSheet()} />}
      ...
      {sheet.kind === "add-agent" && <AddTeammateSheet />}
